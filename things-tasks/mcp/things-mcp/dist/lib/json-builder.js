...
export class ThingsJSONBuilder {
     ...
     */
    async addItemsToProject(params) {
        const results = {
            todos: 0,
            headings: 0,
            errors: []
        ...
        for (const item of params.items) {
            ...
            try {
                ...
                const todoAttributes = this.buildFullTodo(item).attributes;
