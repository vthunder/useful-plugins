...
const DateTimeString = z
    .string()
    .regex(/^\d{4}-\d{2}-\d{2}@\d{2}:\d{2}$/, 'Invalid datetime format. Use YYYY-MM-DD@HH:MM');
const ThingsIdString = z
    .string()
    .regex(/^[A-Za-z0-9]{20,24}$/, 'Invalid Things ID format. Expected: alphanumeric string like "aBc123dEf456gHi789JkL" (20-24 characters). NOT the project name! Use things_get_projects to find the correct ID first.');
