...
Run `dev:arch-doc "Reference Repo Guardrail"` on `useful-plugins` — this is the highest-impact topic because it's the primary failure mode when working with this plugin collection and spans three skills.
